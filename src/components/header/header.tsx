  ...
  return (
    ...
    >
      ...
      <div className="lg:mt-32 md:mt-48 mt-32">
        ...
        <button
        className={`mt-10 font-base lg:font-normal rounded-full border-${storeData.color} px-4 py-2 lg:px-8 lg:py-4 lg:mt-20 hover:bg-${storeData.color} hover:text-c-purple trans`}
        >
        Let's work together!
        </button>
